...
# --- SECTION 4: SECURE ADMIN CONTROL PANEL ---
st.markdown("---")
st.sidebar.subheader("🔒 System Administration")
...
# Password input text box in the sidebar
...
# Render management controls only if authenticated
